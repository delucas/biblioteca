 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}VehiclePartSearchRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}VehiclePartSearchRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "VehiclePartSearch")
public class VehiclePartSearch {
    ...
    protected VehiclePartSearchRequest shared;
    @XmlElement(name = "Request")
    protected List<VehiclePartSearchRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link VehiclePartSearchRequest }
     *     
     */
    public VehiclePartSearchRequest getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(VehiclePartSearchRequest value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<VehiclePartSearchRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<VehiclePartSearchRequest>();
        }
        return this.request;
    }
