 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}SellerLookupRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}SellerLookupRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SellerLookup")
public class SellerLookup {
    ...
    protected SellerLookupRequest shared;
    @XmlElement(name = "Request")
    protected List<SellerLookupRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link SellerLookupRequest }
     *     
     */
    public SellerLookupRequest getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(SellerLookupRequest value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<SellerLookupRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<SellerLookupRequest>();
        }
        return this.request;
    }
