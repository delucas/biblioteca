 ...
 *         &lt;element ref="{http://webservices.amazon.com/AWSECommerceService/2010-12-01}List" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Lists {
    ...
    protected java.util.List<com.ECS.client.jax.List> list;
     ...
     * {@link com.ECS.client.jax.List }
     * 
     * 
     */
    public java.util.List<com.ECS.client.jax.List> getList() {
        if (list == null) {
            list = new ArrayList<com.ECS.client.jax.List>();
        }
        return this.list;
    }
