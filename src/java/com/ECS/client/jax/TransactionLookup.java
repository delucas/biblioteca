 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}TransactionLookupRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}TransactionLookupRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "TransactionLookup")
public class TransactionLookup {
    ...
    protected List<TransactionLookupRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link TransactionLookupRequest }
     *     
     */
    public TransactionLookupRequest getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(TransactionLookupRequest value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<TransactionLookupRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<TransactionLookupRequest>();
        }
        return this.request;
    }
