 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}CustomerContentLookupRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}CustomerContentLookupRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CustomerContentLookup {
    ...
    protected CustomerContentLookupRequest shared;
    @XmlElement(name = "Request")
    protected List<CustomerContentLookupRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link CustomerContentLookupRequest }
     *     
     */
    public CustomerContentLookupRequest getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(CustomerContentLookupRequest value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<CustomerContentLookupRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<CustomerContentLookupRequest>();
        }
        return this.request;
    }
