 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}SellerListingLookupRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}SellerListingLookupRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SellerListingLookup")
public class SellerListingLookup {
    ...
    protected List<SellerListingLookupRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link SellerListingLookupRequest }
     *     
     */
     ...
     * 
     */
    public List<SellerListingLookupRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<SellerListingLookupRequest>();
        }
        return this.request;
    }
