 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}SellerListingSearchRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}SellerListingSearchRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SellerListingSearch {
    ...
    protected SellerListingSearchRequest shared;
    @XmlElement(name = "Request")
    protected List<SellerListingSearchRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link SellerListingSearchRequest }
     *     
     */
    public SellerListingSearchRequest getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(SellerListingSearchRequest value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<SellerListingSearchRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<SellerListingSearchRequest>();
        }
        return this.request;
    }
