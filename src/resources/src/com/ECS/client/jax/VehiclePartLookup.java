 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}VehiclePartLookupRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}VehiclePartLookupRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "VehiclePartLookup")
public class VehiclePartLookup {
    ...
    protected VehiclePartLookupRequest shared;
    @XmlElement(name = "Request")
    protected List<VehiclePartLookupRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link VehiclePartLookupRequest }
     *     
     */
    public VehiclePartLookupRequest getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(VehiclePartLookupRequest value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<VehiclePartLookupRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<VehiclePartLookupRequest>();
        }
        return this.request;
    }
