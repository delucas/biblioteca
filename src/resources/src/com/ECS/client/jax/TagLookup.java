 ...
 *         &lt;element name="Shared" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}TagLookupRequest" minOccurs="0"/>
 *         &lt;element name="Request" type="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}TagLookupRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TagLookup {
    ...
    protected TagLookupRequest shared;
    @XmlElement(name = "Request")
    protected List<TagLookupRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link TagLookupRequest }
     *     
     */
    public TagLookupRequest getShared() {
        return shared;
    }
     ...
     *     
     */
    public void setShared(TagLookupRequest value) {
        this.shared = value;
    }
     ...
     * 
     */
    public List<TagLookupRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<TagLookupRequest>();
        }
        return this.request;
    }
