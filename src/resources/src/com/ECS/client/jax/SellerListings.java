 ...
 *         &lt;element ref="{http://webservices.amazon.com/AWSECommerceService/2011-04-01}SellerListing" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SellerListings")
public class SellerListings {
    ...
    @XmlElement(name = "SellerListing")
    protected List<SellerListing> sellerListing;
    ...
    /**
     * Gets the value of the sellerListing property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sellerListing property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSellerListing().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SellerListing> getSellerListing() {
        if (sellerListing == null) {
            sellerListing = new ArrayList<SellerListing>();
        }
